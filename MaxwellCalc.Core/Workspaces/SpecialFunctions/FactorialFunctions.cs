...
namespace MaxwellCalc.Core.Workspaces.SpecialFunctions
{
    public static class FactorialFunctions
    {
        ...
        /// </remarks>
        /// <remarks>This is copied from the MathNET library.</remarks>
        ...
        public static double FactorialLn(int x)
        {
            ...
            return GammaFunctions.GammaLn(x + 1.0);
        }
        ...
        /// </summary>
        /// <remarks>This was copied from the MathNET library.</remarks>
        /// <param name="n">A nonnegative value n.</param>
