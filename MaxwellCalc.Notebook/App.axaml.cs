...
public partial class App : Application
{
    ...
    public override void OnFrameworkInitializationCompleted()
    {
        ...
        // Saved Sheets command palette (⌘O): a lightweight library of named line-snapshots, kept
        // separate from the workspace store.
        services.AddSingleton<SavedSheetsViewModel>();
